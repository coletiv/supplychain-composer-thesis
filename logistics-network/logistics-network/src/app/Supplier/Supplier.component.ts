...
export class SupplierComponent implements OnInit {
  ...
  constructor(private serviceSupplier:SupplierService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: "org.logistics.testnet.Supplier",
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceSupplier.updateParticipant(form.get("gs1CompanyPrefix").value,this.participant)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
