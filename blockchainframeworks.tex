...
\todo{pedro: explain that ethereum might be expensive to use, but it can be used privately?}
\iffalse
...
\end{itemize}
%TODO: CHECK IF LINKS STILL WORK
...
\todo{fcorreia: reduzir tamanho de letra da tabela seguinte}

\todo{fcorreia: valerá a pena este colorido todo na tabela?}
