...
\subsection*{1. Mandated Constraints}
    \begin{itemize}
        ...
        \todo{fcorreia: isto devia aparecer talvez no início do documento, num glossário geral}
...
\subsection*{1. Scope of the Work}
		\par This project is being developed as a Proof of Concept for the Master Dissertation titled "title\_here". \todo{fcorreia: como isto está incluído na tese, não acho que precises de repetir o título aqui}
...
\begin{itemize}
	...
	\todo{fcorreia: queres dizer os utilizadores do sistema terão estes papeis, e não o sistema, certo?}
