...
\end{table}
    ...
    %in general, it is assumed that the longest valid chain held by the nodes is the correct one.
    %Creator includes reward in the block. Other nodes validate that this was a valid attempt at creating a block. Done.
