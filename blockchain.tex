...
\todo{fcorreia: estou a achar que não há uma justificação forte para ter este capitulo separado do seguinte. É certo que o seguinte tem uma parte de background e outra que que pode ser considerada quase revisão do SotA, mas não me choca tê-las como um único capitulo. o que te parece?}

\todo{fcorreia: que tal chamar a este capitulo qq coisa como "Blockchain Technologies"?}
...
\todo{fcorreia: diminuir ao tamanho de letra da tabela, e eventualmente dimensão máxima de certas colunas, para a fazer caber nas margens.}
...
\todo{fcorreia: era interessante incluir referências para cada uma destas áreas de aplicação que se seguem}
