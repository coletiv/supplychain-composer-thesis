...
\todo{fcorreia: sim, isto parece-me melhor vir mais tarde (ou não vir, ver o comentário no latex aqui)}
...
\todo{fcorreia: aqui, ou algures, precisas de explicar que o objetivo era que a tua abordagem fosse guiada por necessidades da prática atual no domínio das SCs. Reconheceu-se que o importante seria obter esse conhecimento a partir de peritos da área. Mostrando-se impossível ter acesso direto a essas pessoaos, a forma arranjada para obter esse conhecimento foi usando um survey}
...
\todo{fcorreia: sobre a ultima frase: sim e não. ter conhecimento de BC não quer dizer que se seja fanboy :-) pode simplesmente tanto querer dizer que se está bem informado como querer dizer que se está mal informado...}
...
\todo{fcorreia: queres dizer graphs em vez de graphics}

\todo{fcorreia: "Table 6.1" ("t" maiusculo)}
